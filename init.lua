...
-- Diagnostic keymaps
vim.keymap.set('n', 'ep', vim.diagnostic.goto_prev, { desc = 'Go to previous [D]iagnostic message' })
vim.keymap.set('n', 'en', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
...
vim.keymap.set('n', '<leader>bS', ':wa<CR>', { silent = true, noremap = true, desc = 'save buffer' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch [G]rep in directory' })
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- gopls = {},
        -- pyright = {},
        -- pylsp = {}, -- config here: https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#pylsp
        basedpyright = {
          settings = {
            basedpyright = {
              analysis = {
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function(_, opts)
      ...
      } -- -> it is installed but calling setup is optional
    end,
  },
