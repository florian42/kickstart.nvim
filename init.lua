...
vim.keymap.set('n', '<leader>ob', require('telescope.builtin').buffers, { desc = 'Find [Open] [b]uffers' })
...
vim.keymap.set('n', '<leader>sb', require('telescope.builtin').builtin, { desc = '[S]earch [S]elect Telescope' })
